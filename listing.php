    ...
    <div class="row">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($students['marks']) ?></td>
                <td>
                <a href="<?= base_url('student/edit/'.$students['id']) ?>" class="btn btn-success btn-sm">Edit</a>
                <a href="<?= base_url('student/delete/'.$students['id']) ?>" class="btn btn-danger btn-sm">Delete</a>
                <a href="#" class="btn btn-primary btn-sm openModal" data-id="<?= $students['id'] ?>">
                    <?= !empty($students['marks']) ? 'Update marks' : 'Add marks' ?>
                </a>
                </td>
            </tr>
            <?php } ?>
...
$(document).ready(function () {
    $('.openModal').on('click', function (e) {
      ...
      $.get("<?= base_url('listing/getstudentdata') ?>", function (data) {
        console.log(data);
